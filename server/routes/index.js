...
router.get(
  ...
  recipeController.getTopRecipes,
  recipeController.getRecipesBySearch
);
router.post(
  '/',
  authenticate,
  Validation.addRecipeValidation,
...
router.put(
  '/:recipeId',
  authenticate, Validation.recipeId,
  Validation.editRecipeValidation,
...
router.get(
  '/most-favorites',
  recipeController.listMostFavoritedRecipes
);
router.get(
  '/:recipeId',
  authenticate, Validation.recipeId,
...
router.delete(
  '/:reviewId/reviews',
  authenticate, Validation.reviewId,
