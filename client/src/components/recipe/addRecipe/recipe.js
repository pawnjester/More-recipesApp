    ...
    return (
        <div className="card">
            ...
            <div className="card-body">
              <h4 className="card-title">nn</h4>
              <p className="card-text">efgr</p>

            </div>
            <div className="card-body clearfix">
              <div className="text-left text-success float-left">
                <i className="fa fa-pencil" aria-hidden="true"></i><a href="" data-toggle="modal" data-target="#editModal"><span id='clickableAwesomeFont' class="text-success">&nbsp;Edit</span></a>
              </div>
