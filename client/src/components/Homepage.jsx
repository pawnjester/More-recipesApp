              ...
              <div className="row">
                <div className="col-lg-8 d-none d-lg-block">
                  ...
                  <div className="d-flex flex-row">
                    ...
                    <div className="p-4 align-self-end " id="create-an-account">
                      Create an account
                    </div>
                ...
                <div className="col-lg-4">
                  <div className="card bg-danger text-center card-form">
                    <div className="card-body">
                      ...
                      <SignUpFormComponent userSignupRequest={userSignupRequest} />
                    </div>
                  </div>
                </div>
              </div>
        ...
        {isAuthenticated && (
          <section id="">
            <div className="conatiner text-center">
              <h1 className="pt-3 mb-5" id="most-loved-recipes">Most Loved Recipes</h1>
              <div className="row ml-3 mr-3">
                {UpvotedRecipesList.length < 1 && (<h4 className="mt-5 text-center no-recipes mb-5"> No recipes yet </h4>)}
                {UpvotedRecipesList.map(upvoted => <UpvotedRecipesComponent recipe={upvoted} key={upvoted.id} />)}
              </div>
            </div>
          </section>)}
        <section id="">
          <div className="conatiner text-center">
            <h1 className="pt-3 mb-5" id="most-favorited-recipes">Most Favorited Recipes</h1>
            <div className="row ml-3 mr-3">
              {mostFavorite.length < 1 && (<h4 className="mt-5 text-center no-recipes mb-5"> No recipes yet </h4>)}
              {mostFavorite.map(mostfav => <UpvotedRecipesComponent recipe={mostfav} key={mostfav.id} />)}
            </div>
          </div>
        </section>
        <FooterComponent />
